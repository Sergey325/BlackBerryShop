...
export default function Header() {
    ...
    return (
        <header className="w-full border-b border-gray-200 text-base bg-gray-50 relative z-20">
            <div className="max-w-[1366px] mx-auto flex items-center justify-between h-18">
                ...
                {/* Десктоп телефон */}
                <div className="hidden md:block relative group rounded-sm hover:shadow-[0_0_10px_rgba(0,0,0,0.1)] hover:bg-white transition-all duration-300 mt-2 py-3 px-4  self-start">
