...
export const metadata: Metadata = createMetadata({
    ...
    description: "Договір публічної оферти інтернет-магазину Black Berry: оформлення замовлення, оплата, доставка, повернення товару та обробка персональних даних.",
    path: "/offer",
});
